...
export const RAINBOW = [
    { stop: 0.7, color: "#6465FF" },
    { stop: 0.6, color: "#40AAFF" },
    { stop: 0.5, color: "#58d68d" },
    { stop: 0.4, color: "#DFFF00" },
    { stop: 0.3, color: "#FFBF00" },
    { stop: 0.2, color: "#FF7F50" },
    { stop: 0.1, color: "#DE3163" }
];

export const SKY = [
    { stop: 0.7, color: "#40AAFF" },
